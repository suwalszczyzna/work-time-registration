...
from free_days_registration.views import free_days_form_view, free_days_form_summary_view, free_days_form_boot_view
...
urlpatterns = [
    ...
    path('free_days_form2/', free_days_form_boot_view, name='free-days-form'),
